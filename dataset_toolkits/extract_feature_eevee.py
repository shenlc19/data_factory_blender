...
if __name__ == '__main__':
    ...
    # get file list
    if os.path.exists(os.path.join(opt.output_dir, 'metadata_valid_v3.csv')):
        metadata = pd.read_csv(os.path.join(opt.output_dir, 'metadata_valid_v3.csv'))
    else:
        raise ValueError('metadata_valid_v3.csv not found')
