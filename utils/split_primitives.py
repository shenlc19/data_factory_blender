...
OUTPUT_DIR = 'datasets/glassverse_07856_single'
...
if __name__ == "__main__":
    bpy.ops.wm.open_mainfile(filepath='/DATA_EDS2/shenlc2403/data_factory/data_factory_blender/datasets/glassverse_v0_filtered/007856/lm.blend')
